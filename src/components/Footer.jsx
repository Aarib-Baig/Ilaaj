        ...
        <div className='max-w-[1200px] mx-auto p-4 md:p-8'>
            <div className='grid grid-cols-3'>
                <div>
                    ...
                    <h2 className='mt-1 font-semibold'>404 Page</h2>
                </div>

                <div>
                    <h1 className='flex items-center font-bold text-2xl gap-2'>Contact <span className='text-[#3e8cff]'><TbActivityHeartbeat /></span></h1>

                    <h2 className='font-semibold mt-1 flex items-center gap-2 w-2/3'><span className='text-[#3e8cff] text-2xl'><CiLocationOn /></span>span 24A Kingston Street, Los Vegas NC 28202, USA.</h2>

                    <h2 className='font-semibold mt-1 flex items-center gap-2'><span className='text-[#3e8cff] text-2xl'><MdOutlineMailOutline /></span>support@doctorate.com</h2>
                ...
                <div>
                     ...
                     <h2 className='font-semibold mt-1'>The Doctorate staff members are
well trained professionals.</h2>
